<div>
    <section class="px-4 pt-8 sm:px-6">
        {{-- Title --}}
        <x-pages.page-title title="Pemeliharaan Baru" />
            ...
            <div class="w-full overflow-x-auto rounded-md bg-white dark:bg-gray-800 shadow">
                <form wire:submit="submitData">
                    <div class="flex flex-wrap p-6">
                        ...
                        <x-forms.attributes.information title="Pemeliharaan Perangkat"
                        ...
                        <div class="w-full lg:w-2/3">
                            {{-- Perangkat --}}
                            <x-forms.inputs.text model="form.device_name" label="Nama Perangkat" type="text" />
