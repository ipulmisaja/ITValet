<div>
    <section class="px-4 pt-8 sm:px-6">
        {{-- Page Title --}}
        <x-pages.page-title title="Pengaturan Hak Akses" />
        ...
        <div class="mb-6 mt-10">
            <div
                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <x-forms.inputs.search placeholder="Cari Hak Akses ..." />
                ...
                <x-pages.page-button :route="route('role-permission.create')" icon="plus-circle" title="Hak Akses" />
            </div>
                                ...
                                <tr
                                    ...
                                    <td class="px-6 py-4">
                                        <ul style="list-style-type:disc"
                                            class="text-gray-500 dark:text-gray-400 lg:space-y-2 flex flex-col lg:grid lg:grid-cols-3 gap-2 lg:gap-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex place-items-center space-x-3">
                                            {{-- Edit Hak Akses --}}
                                            <x-pages.cell-button.navigate :route="route('role-permission.edit', $role->id)" tooltip="Role"
                                                color="text-primary-400 hover:text-primary-500" icon="key" />

                                            <x-pages.cell-button.delete-item :id="$role->id" />
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
