@switch($name)
    ...
    @case('close-modal')
        <svg class="{{ $class }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
            viewBox="0 0 14 14">
    ...
    @case('exclamation-circle')
        <svg class="{{ $class }}" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
