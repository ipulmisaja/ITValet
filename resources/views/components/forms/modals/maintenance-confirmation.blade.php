        ...
        <div class="mx-auto w-screen max-w-md">
            <div class="rounded-lg bg-white">
                ...
                <div class="flex flex-nowrap place-items-center justify-between mb-8 p-6 border-b">
                    <div class="font-semibold leading-6 text-xl text-neutral-600">Konfirmasi Pemeliharaan</div>
                ...
                {{-- Modal Content --}}
                <div class="px-6 pb-6">
                    <span>Apakah anda yakin menyetujui pengajuan pemeliharaan perangkat ini ?</span>
                </div>
                {{-- Modal Footer --}}
                <div class="rounded-b-md bg-gray-200 px-6 py-3 flex justify-center place-items-center space-x-4">
                    <button wire:click="$set('modal', false)"
                    ...
                    <form wire:submit="confirmMaintenance">
                        <button type="submit"
                            class="flex py-2 px-3 text-sm font-medium text-center text-white bg-primary-600 rounded-md hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600">
                            <div wire:loading>
