<div
    x-data="{ showModal: @entangle('modal') }"
    ...
    <div
        ...
        class="fixed inset-0 z-9999 bg-slate-900/75">
    </div>
    ...
    <div
        ...
        x-show="showModal"
        x-transition
        class="fixed inset-0 z-99999 flex place-items-center justify-center">
        <div class="mx-auto w-screen max-w-md">
            <div class="rounded-lg bg-white">
                {{-- Modal Title --}}
                <div class="flex flex-nowrap place-items-center justify-between mb-8 p-6 border-b">
                    <div class="font-semibold leading-6 text-xl text-neutral-600">Konfirmasi Hapus Data</div>
                    <button
                ...
                <div class="rounded-b-md bg-gray-200 px-6 py-3 flex justify-center place-items-center space-x-4">
                    ...
                    <form wire:submit="confirmDelete">
                        <button type="submit"
                            ...
                            <div wire:loading>
                                <svg class="animate-spin -ml-1 mr-2 h-5 w-5 text-red-800" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24">
